            ...
            <main class="mn-inner">
                ...
                <div class="row">
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="page-title" style="color: #4682B4; font-size: 20px"><strong>Change Pasword</strong></div>
                    </div>
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="card">
    ...
    <?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) {
        ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                                        <div class="row">
                                            ...
                                            <div class="input-field col s12">
                                                <button type="submit" name="change" class="btn" style="background: #4682B4" onclick="return valid();">Change</button>
